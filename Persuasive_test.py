...
# data = []
# result=[]
workbook = xlrd.open_workbook("Persuasive TFIDF Analysis.xlsx", on_demand=True)
sheet = workbook.sheet_by_name(sheetname)
arrayofvalues = sheet.col_values(3,1)

wb =openpyxl.load_workbook(filename = 'Persuasive TFIDF Analysis.xlsx')
...
wb.save("Persuasive TFIDF Analysis.xlsx")
